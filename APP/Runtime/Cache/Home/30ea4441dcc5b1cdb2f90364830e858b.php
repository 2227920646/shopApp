...
<div class="container">
    ...
    <form action="<?php echo U('register');?>" method="post" autocomplete="off" class="form-signin">
        ...
        <a href="http://localhost/te/index.php/Home/Index/login.html"><button class="btn btn-lg btn-primary btn-block" type="submit" id="signinSubmit">注册</button></a>
    </form>
    <div class="footer">
