      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo U(login);?>" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
...
<script src="/te/Public/lib/ueditor/ueditor.config.js"></script> 
<script src="/te/Public/lib/ueditor/ueditor.all.min.js"> </script> 
<script src="/te/Public/lib/ueditor/lang/zh-cn/zh-cn.js"></script>  
