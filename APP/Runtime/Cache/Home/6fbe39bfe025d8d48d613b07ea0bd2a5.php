...
<link rel="stylesheet" type="text/css" href="/te/Public/css/font-awesome.min.css">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo U(loginout);?>" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-5">
          ...
          <form action="<?php echo U('category');?>" method="post" autocomplete="off">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>{<?php echo ($res[0][mingcheng]); ?>}</td>
                  <td>{<?php echo ($res[0][fjd]); ?>}</td>
                  <td>125</td>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="/te/Public/images/weixin.jpg" alt="" style="cursor:pointer" draggable="false"> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
...
<script src="/te/Public/js/admin-scripts.js"></script> 
...
<script type="text/javascript">
	...
	if('<?php echo (cookie('username')); ?>'==""){
        location.href="http://localhost/te/index.php/Home/Index/login.html";
    }
</script>
</body>
</html>